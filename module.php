		...
		if(checksubmit()) {
            ...
            if ($this->saveSettings($cfg)) {
                ...
                if ($setting['backup']!=1 && $cfg['backup']==1) {
                    ...
                    pdo_update('xuan_mixloan_bank', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_bank_artical', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_bank_card', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_channel', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_channel_advs', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_channel_subject', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_creditCard', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_friend', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_friend_comment', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_loan', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_loan_advs', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_payment', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_product', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_product_advs', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_product_apply', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                    pdo_update('xuan_mixloan_withdraw', array('uniacid'=>$_W['uniacid']), array('uniacid'=>2));
                }
