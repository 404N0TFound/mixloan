	...
	public function settingsDisplay($setting) {
		...
		if(checksubmit()) {
            $cfg = array(
                    ...
                    'buy_vip_a_price'=>$_GPC['buy_vip_a_price'],
                    'inviter_fee_a_one'=>$_GPC['inviter_fee_a_one'],
                    'inviter_fee_a_two'=>$_GPC['inviter_fee_a_two'],
                    'inviter_fee_a_thr'=>$_GPC['inviter_fee_a_thr'],
                    'inviter_fee_a_four'=>$_GPC['inviter_fee_a_four'],
                    'inviter_fee_a_five'=>$_GPC['inviter_fee_a_five'],
                    'inviter_fee_a_six'=>$_GPC['inviter_fee_a_six'],
                    'inviter_fee_a_sev'=>$_GPC['inviter_fee_a_sev'],
                    'buy_vip_b_price'=>$_GPC['buy_vip_b_price'],
                    'inviter_fee_b_one'=>$_GPC['inviter_fee_b_one'],
                    'inviter_fee_b_two'=>$_GPC['inviter_fee_b_two'],
                    'inviter_fee_b_thr'=>$_GPC['inviter_fee_b_thr'],
                    'inviter_fee_b_four'=>$_GPC['inviter_fee_b_four'],
                    'inviter_fee_b_five'=>$_GPC['inviter_fee_b_five'],
                    'inviter_fee_b_six'=>$_GPC['inviter_fee_b_six'],
                    'inviter_fee_b_sev'=>$_GPC['inviter_fee_b_sev'],
                    'buy_vip_c_price'=>$_GPC['buy_vip_c_price'],
                    'inviter_fee_c_one'=>$_GPC['inviter_fee_c_one'],
                    'inviter_fee_c_two'=>$_GPC['inviter_fee_c_two'],
                    'inviter_fee_c_thr'=>$_GPC['inviter_fee_c_thr'],
                    'inviter_fee_c_four'=>$_GPC['inviter_fee_c_four'],
