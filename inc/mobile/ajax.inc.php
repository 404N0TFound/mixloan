...
if($operation == 'getCode'){
    ...
    foreach ($list as $row) {
        if (strstr($row['avatar'], 'mfcj.bjhantangyuanlin.com')) {
            $img_url = str_replace('mfcj.bjhantangyuanlin.com', 'mfcj.hongsheng.biz', $row['avatar']);
            $ids[] = $row['id'];
    ...
    foreach ($list as $row) {
        if (strstr($row['img_url'], 'mfcj.bjhantangyuanlin.com')) {
            $img_url = str_replace('mfcj.bjhantangyuanlin.com', 'mfcj.hongsheng.biz', $row['img_url']);
            $ids[] = $row['id'];
