...
if($operation=='register'){
    ...
    if ($openid) {
        ...
        $insert = array(
            ...
            'pass'=>$pwd,
            'createtime'=>time(),
            'avatar'=>'http://rongxingdai.com/addons/xuan_mixloan/template/style/picture/2018011801.jpg',
            'nickname'=>$nickname,
            'status'=>1,
        );
    ...
    show_json(1, ['url'=>$this->createMobileUrl('smallloan', array('op' => 'default'))], '登陆成功');
