...
if($operation=='register'){
    ...
    if ($openid) {
        ...
        $insert = array(
            ...
            'pass'=>$pwd,
            'createtime'=>time(),
            'avatar'=>'http://weixin.jhhai.cn/addons/xuan_mixloan/template/style/picture/2018011801.jpg',
            'nickname'=>$nickname,
            'status'=>-2,
        );
    ...
    if (isset($_COOKIE['user_id'])) {
        header("location:{$this->createMobileUrl('smallloan')}");
    }
    ...
    show_json(1, ['url'=>$this->createMobileUrl('smallloan')], '登陆成功');
