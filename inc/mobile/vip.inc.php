...
if($operation=='buy'){
	...
	//提现
	$banks = pdo_fetchall("SELECT id,bankname,banknum,realname,phone FROM ".tablename("xuan_mixloan_creditCard")." WHERE uid=:uid", array(':uid'=>$member['id']));
