...
if($operation=='buy'){
    ...
    {
        $notify_url = 'http://wx.baoyu123.top/addons/xuan_mixloan/lib/wechat/payResult.php';
    ...
    if ($type=='10001') {
        ...
        if ($inviter_thr) {
            ...
            //消息提醒
            $ext_info = array('content' => "您好，您的团队邀请了{$member['nickname']}成功购买了代理会员，奖励您推广佣金" . $re_bonus . "元，继续推荐代理，即可获得更多佣金奖励", 'remark' => "点击查看详情", "url" => $salary_url);
            $insert = array(
                'is_read'=>0,
                'uid'=>$member['id'],
                'type'=>2,
