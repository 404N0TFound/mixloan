...
require_once('/www/wwwroot/3dmjg.com/addons/xuan_mixloan/lib/alipay/aop/AopClient.php');
require_once('/www/wwwroot/3dmjg.com/addons/xuan_mixloan/lib/alipay/aop/request/AlipayFundTransToaccountTransferRequest.php');
class Xuan_mixloan_Alipay
{
    private $gatewayUrl = 'https://openapi.alipay.com/gateway.do';
    private $appId = '2018081661051593';
