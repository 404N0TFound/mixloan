...
{
    private $appid = "wx1e2ebe45185d89fd";
    private $mchid = "1511812281";
    private $secrect_key = "avgga2okzo1dnp4nly2zpidy5fxnghtc";
    ...
    function H5pay($trade_no, $amount, $notify_url)
    {
        ...
        $params['body'] = 'e代微服官方充值';
        $params["spbill_create_ip"] = $this->getRealIp();
        $params["total_fee"] = intval($amount*100);
        $params["notify_url"] = $notify_url;
        $params["trade_type"] = "MWEB";
        $params["scene_info"] = '{"h5_info": {"type":"Wap","wap_url": "http://www.edjrw.com","wap_name": "e代微服官方充值"}}';
