...
class Xuan_mixloan_Product
{
    ...
    public function getRecommends(){
        global $_W;
        $sql = "SELECT * FROM ".tablename('xuan_mixloan_product')." where uniacid=:uniacid AND is_show=1 AND is_hot=1 order by id desc limit 5";
    ...
    **/
    ...
    public function getInviteList($params=[]) {
        ...
        if (!empty($uids)) {
            ...
            $con .= " AND a.uid NOT IN {$uids_string} AND a.uniacid={$_W['uniacid']}";
        }
