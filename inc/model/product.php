...
class Xuan_mixloan_Product
{
    ...
    **/
    public function getApplys($params=[]) {
        ...
        $sql = "SELECT {$fields} FROM ".tablename("xuan_mixloan_product_apply")." WHERE uniacid={$_W['uniacid']} AND createtime>={$begin} AND createtime<{$end} AND inviter={$inviter} AND type=1";
