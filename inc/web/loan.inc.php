...
if ($operation == 'list') {
    ...
    if ($_GPC['post'] == 1) {
        ...
        $data['ext_info']['detail'] = htmlspecialchars_decode($data['ext_info']['detail']);
        $data['ext_info']['condition'] = htmlspecialchars_decode($data['ext_info']['condition']);
    ...
    if ($_GPC['post'] == 1) {
        ...
        $_GPC['data']['ext_info']['detail'] = htmlspecialchars_decode($_GPC['data']['ext_info']['detail']);
        $_GPC['data']['ext_info']['condition'] = htmlspecialchars_decode($_GPC['data']['ext_info']['condition']);
