...
if ($operation == 'list') {
    ...
    $sql = 'select a.id,a.uid,b.nickname,b.avatar,a.createtime,a.fee,a.tid,a.effecttime from ' . tablename('xuan_mixloan_payment') . " a left join ".tablename("xuan_mixloan_member")." b ON a.uid=b.id where a.uniacid={$_W['uniacid']} " . $wheres . ' ORDER BY a.id DESC';
