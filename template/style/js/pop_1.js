...
document.writeln("		            <h2>您还不是i代代理，点击下方“立即购买”使用此功能！</h2>");
document.writeln("		            <p>温馨提示：如有疑问,请联系客服(微信:idai2020)</p>");
document.writeln("		            <div class=\'buy_hf clearfix\'>");
document.writeln("			            <a href=\'/Wap/goods/index/id/1.html\' ><img src=\'../addons/xuan_mixloan/template/style/images/buy.png\' /></a>");
document.writeln("			        </div>        ");
document.writeln("			        <div class=\'layer_close\'><img src=\'../addons/xuan_mixloan/template/style/images/del.png\' /></div>");
document.writeln("		        </div>");
document.writeln("		    </div>    ");
document.writeln("    	</div>");
