...
class Xml{
	 ...
	 * @return 商户预授权完成订单号
	 */
	function getMerDealId() {
		return $this->MerDealId;
	}
	
	/**
	 * @param MerDealId 商户预授权完成订单号
	 */
	function setMerDealId($merDealId) {
		$this->MerDealId = $merDealId;
	}
}
?>
