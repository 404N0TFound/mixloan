...
/**
 * 【预授权H5页面版本】商户对接下单接口封装
 * 易联服务器交易接口调用API封装，分别对以下接口调用进行了封装；
 * 接口封装了参数的转码（中文base64转码）、签名和验证签名、通讯和通讯报文处理
 * 1、【预授权H5页面版本】的商户订单下单接口
 * 2、【预授权H5页面版本】的生成订单支付重定向地址
 */
class TransactionClientH5 {
	/**
	 * 【预授权H5页面版本】的商户订单下单接口(H5版本)，本接口比SDK的下单接口增加了【returnUrl】和【clientIp】参数
