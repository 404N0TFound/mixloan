...
class Constants {
  ...
  //商户接收订单通知接口地址（异步通知）；；
  private static  $MERCHANT_NOTIFY_URL = "http://www.edjrw.com/app/index.php?i=2&c=entry&op=pay_result&do=ajax&m=xuan_mixloan";
  //商户接收订单通知接口地址(同步通知),H5版本对接需要该参数；
  public static $MERCHANT_RETURN_URL = "http://www.edjrw.com/app/index.php?i=2&c=entry&op=pay_result&do=ajax&m=xuan_mixloan";
  //商户RSA私钥，商户自己产生
