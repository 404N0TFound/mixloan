...
$codepay_config['path'] = $codepay_config['host'] . '/addons/xuan_mixloan/lib/codepay/'; //API安装路径 最终为http://域名/codepay
...
$price = (float)$config['buy_vip_price']; //提交的价格
