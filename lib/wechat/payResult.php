...
$stringSignTemp = $buff . 'key=incrmbxbhdqpskvwcqfpishbzlke52xr';//key为证书密钥
$sign = strtoupper(md5($stringSignTemp));
//判断算出的签名和通知信息的签名是否一致
$json = json_encode($data);
$con = mysqli_connect("127.0.0.1","wx_91sckj_top","XfHp8Z6Zn5","wx_91sckj_top");
if($sign == $data['sign']){
    if ($data['result_code'] == 'SUCCESS') {
        ...
        mysqli_query($con, $sql);
        mysqli_close($con);
        header("location:http://juxinwangluo.xin/app/index.php?i=4&c=entry&op=notify_url" .
