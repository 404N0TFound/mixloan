...
$stringSignTemp = $buff . 'key=ab123456789001234567891234567890';//key为证书密钥
$sign = strtoupper(md5($stringSignTemp));
//判断算出的签名和通知信息的签名是否一致
$json = json_encode($data);
$con = mysqli_connect("127.0.0.1","root","d0a2c71fdb154d67","we7");
if($sign == $data['sign']){
    if ($data['result_code'] == 'SUCCESS') {
        ...
        mysqli_query($con, $sql);
        mysqli_close($con);
        header("location:http://wx.wd8818.cn/app/index.php?i=1&c=entry&op=notify_url" .
